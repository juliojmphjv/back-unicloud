...
class CheckRoot:
    ...
    def is_root(self):
        ...
        logger.info(f'user is staff: {self.__request.user.is_staff}')
        logger.info(f'user is superuser: {self.__request.user.is_superuser}')
        logger.info(f'customer is root: {self.__request.user.is_staff}')
